                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <h3>Una volta selezionate le Prenotazioni interessate è possibile utilizzare le seguenti funzioni:</h3>
                                 <button type="submit" class="col-md-3 btn btn-success" onclick="if(confirm('Sei sicuro di voler modificare lo stato di queste operazioni in: Eseguita ?')){submitForm('gestprenotazioni?cmd=eseguita')}">Cambia stato delle Prenotazioni selezionate in:<strong>Eseguite </strong>  <i class="far fa-calendar-check"></i></button>
                                 <button type="submit" class="col-md-3 btn btn-warning" onclick="if(confirm('Sei sicuro di voler modificare lo stato di queste operazioni in: Non eseguita ?')){submitForm('gestprenotazioni?cmd=noneseguita')}">Cambia stato delle Prenotazioni selezionate in: <strong>Non Eseguite </strong> <i class="fas fa-times-circle"></i></button>
                                 <button type="submit" class="col-md-3 btn btn-primary" onclick="if(confirm('Sei sicuro di voler modificare lo stato di queste operazioni in: In attesa ?')){submitForm('gestprenotazioni?cmd=attesa')}">Cambia stato delle Prenotazioni selezionate in: <strong>Attesa </strong> <i class="fas fa-user-clock"></i></button>
                                 <button type="submit" class="col-md-3 btn btn-danger" onclick="if(confirm('Sei sicuro di voler eliminare definitivamente queste operazioni dal database?')){submitForm('gestprenotazioni?cmd=elimina')}" >Elimina le Prenotazioni selezionate <i class="fas fa-trash-alt"></i></button>
                                  <h3></h3> 
                                    <thead>
                                        <tr>
