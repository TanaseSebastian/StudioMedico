...
<!-- Begin Page Content -->
 <div class="container-fluid">
						<form action="gestutenti?cmd=adminregister" method="POST"  class="signin-form">
						 <div class="form-group mb-3">
			      		...
			      		<div class="form-group mb-3">
			      			<label class="label" for="email">Username Amministratore</label>
		            ...
		            <div class="form-group">
		            	<button type="submit" class="form-control btn btn-primary submit px-3">Inserisci Amministratore</button>
		            </div>
