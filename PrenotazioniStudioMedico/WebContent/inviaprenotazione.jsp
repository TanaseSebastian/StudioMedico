...
<body>
		...
		<div class="container d-flex align-items-center">
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li><a class="nav-link scrollto active" href="#appointment"><span
							class="d-none d-md-inline">Prenota un appuntamento</span></a></li>
			...
			<%if(autente_loggato!="true"){%>
			<a href="login.jsp" class="login-btn scrollto"><span
				class="d-none d-md-inline">Esegui Login</span></a>
			<%}else if(autente_loggato.equals("true")){ %>
			<a><span class="d-none d-md-inline logo me-auto"
				style="margin-left: 15px; font-size: 16px;">Benvenuto <%=user.getNOME() %>
			</span></a> <a href="logout"><span class="d-none d-md-inline logo me-auto"
				style="margin-left: 15px; font-size: 16px;">Logout </span></a>
			<%} %>
		</div>
	</header>
	<!-- End Header -->
	...
	<main id="main">
		...
		<!-- ======= Appointment Section ======= -->
		<section style="margin-top: 100px" id="appointment"
			...
			<div class="section-title">
              ...
              case "1": %>
				<h2>
					Prenota un appuntamento <br> Hai selezionato il dipartimento
					di: Cardiologia
				</h2>
				<% break;
              case "2":%>
              ...
              case  "5":%>
				...
				<p>Inserisci i dati della form e prenota subito il tuo
					appuntamento,ti aspettiamo!</p>
			</div>

			<form action="gestprenotazioni?cmd=inserisci" method="post"
				role="form">
				<div class="row">
					<div class="col-md-3 form-group">
						<input type="text" name="name" class="form-control" id="name"
							placeholder="Il tuo Nome" data-rule="minlen:4"
							data-msg="Perfavore inserisci almeno 4 caratteri"
							readonly="readonly">
					</div>
					<div class="col-md-3 form-group mt-3 mt-md-0">
						<input type="email" class="form-control" name="email" id="email"
							placeholder="La tua Email" data-rule="email"
							data-msg="Perfavore inserisci una email valida"
							readonly="readonly">
					</div>
					<div class="col-md-3 form-group mt-3 mt-md-0">
						<input type="text" class="form-control" name="cf" id="cf"
							placeholder="inserire codice fiscale" data-rule="minlen:16"
							maxlength="16" data-msg="Inserisci 16 caratteri"
							readonly="readonly">
					</div>
					<div class="col-md-3 form-group mt-3 mt-md-0">
						<input type="text" class="form-control" name="phone" id="phone"
							placeholder="Il Numero Cellulare" data-rule="minlen:10"
							maxlength="13" data-msg="Please enter at least 10"
							readonly="readonly">
					</div>
				</div>
				<div class="row">
				...
				<div class="text-center" style="margin-top: 30px;">
					<button type="submit" class="btn btn-primary">Prenota
						appuntamento</button>
				</div>
			</form>
			...
			<div class="container" id="usernotLogged">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<h1 style="color: #0B5ED7; font-weight: bold; text-align: center;">Per
							favore utente,per poter prenotare un appuntamento bisogna prima
							loggarsi.</h1>
					</div>
		...
		<!-- End Appointment Section  if user not logged-->
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-1.jpg"
								...
								src="assets/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-2.jpg"
								class="galelry-lightbox"> <img
								src="assets/img/gallery/gallery-2.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-3.jpg"
								class="galelry-lightbox"> <img
								src="assets/img/gallery/gallery-3.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-4.jpg"
								class="galelry-lightbox"> <img
								src="assets/img/gallery/gallery-4.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-5.jpg"
								class="galelry-lightbox"> <img
								src="assets/img/gallery/gallery-5.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a href="assets/img/gallery/gallery-8.jpg"
								class="galelry-lightbox"> <img
								src="assets/img/gallery/gallery-8.jpg" alt="" class="img-fluid">
							</a>
						</div>
					</div>
			...
			<div class="mapouter">
				<div class="gmap_canvas">
					<iframe width="100%" height="500" id="gmap_canvas"
						src="https://maps.google.com/maps?q=piazza%20san%20domenico,Casarano&t=&z=15&ie=UTF8&iwloc=&output=embed"
							...
							<form action="forms/contact.php" method="post" role="form"
								...
								<div class="row">
									<div class="col-md-6 form-group">
										<input type="text" name="name" class="form-control" id="name"
											placeholder="Il tuo Cognome e Nome" required>
									</div>
								...
								<div class="form-group mt-3">
									<input type="text" class="form-control" name="subject"
										id="subject" placeholder="oggetto del messaggio" required>
								</div>
								<div class="form-group mt-3">
									<textarea class="form-control" name="message" rows="5"
								...
								<div class="my-3">
									...
									<div class="sent-message">Il tuo messsaggio &eacute;
										stato inviaato correttamente,grazie!</div>
								</div>
								<div class="text-center">
	...
	<footer id="footer">
		...
		<div class="container d-md-flex py-4">
			...
			<div class="me-md-auto text-center text-md-start">
				<div class="copyright">
					&copy; Copyright <strong><span>RESTINO,ROSSETTO,GIANGRECO,TANASE</span></strong>.
					All Rights Reserved
				</div>
				<div class="credits">
					Designed by <a href="#">RestinoSamuele,Rossetto
						Francesco,Giangreco Davide,Tanase Sebastian</a>
				</div>
			</div>
