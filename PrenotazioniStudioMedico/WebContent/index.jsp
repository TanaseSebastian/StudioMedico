        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <p>L'implantologia è una specializzazione dell'odontoiatria che permette di sostituire denti mancanti, attraverso il posizionamento di impianti dentali fissi.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>Anche i denti dei più€ piccoli hanno bisogno di cure, indispensabili per garantire un corretto sviluppo orale e scheletrico. Ci dedichiamo alla salute dei vostri figli comunicando con loro nel modo piu€ adeguato alla loro età.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>E'€ quella parte dell'€™odontoiatria che si occupa di progettare e costruire protesi dentali fisse per ripristinare la dentatura originaria perchè persa o compromessa.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>Si occupa della diagnosi e della cura delle malattie dei tessuti che sostengono i denti cioè le gengive i legamenti e le ossa alveolari.</p>
            </div>
          </div>
