			      	...
			      	<div class="d-flex">
						 ...
						 <%=messaggio%>
			      		...
			      		<div class="form-group mb-3">
			      			...
			      			<input type="tel" class="form-control" name="phone" id="phone" placeholder="Inserisci il Numero Cellulare" minlength="10" maxlength="10" title="Please enter at least 10" required>
			      		</div>
