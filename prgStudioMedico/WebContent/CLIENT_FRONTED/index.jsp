<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%!
    String autente_loggato="false";
	//elenco = (ArrayList<Ordini>)session.getAttribute("ELENCO_ORDINI");
	%>  
<!DOCTYPE html>
<html lang="it">
...
<head>
  ...
  <!-- =======================================================
  * Template Name: Dentilab - v4.0.1
  * Template URL: https://bootstrapmade.com/Dentilab-free-medical-bootstrap-theme/
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Prenota un appuntamento</span></a>
      <a href="..\\LOGIN\\login.jsp"  class="login-btn scrollto"><span class="d-none d-md-inline">Esegui</span> Login</a>
    </div>
  </header><!-- End Header -->
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>Anche i denti dei più piccoli hanno bisogno di cure, indispensabili per garantire un corretto sviluppo orale e scheletrico. Ci dedichiamo alla salute dei vostri figli comunicando con loro nel modo più adeguato alla loro età.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <p>L’ortodonzia si occupa di correggere i difetti di occlusione, di allineamento dentale e di armonizzare lo sviluppo delle ossa mascellari.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>È quella parte dell’odontoiatria che si occupa di progettare e costruire protesi dentali fisse per ripristinare la dentatura originaria perché persa o compromessa.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>Si occupa della diagnosi e della cura delle malattie dei tessuti che sostengono i denti cioè le gengive i legamenti e le ossa alveolari.</p>
            </div>
          </div>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" id="userLogged">
        ...
        <form action="#inserire la servelet---" method="post" role="form" class="php-email-form" >
          <div class="row">
            <div class="col-md-4 form-group">
              <input type="text" name="name" class="form-control" id="name" placeholder="Il tuo Nome" data-rule="minlen:4" data-msg="Perfavore inserisci almeno 4 caratteri">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="email" class="form-control" name="email" id="email" placeholder="La tua Email" data-rule="email" data-msg="Perfavore inserisci una email valida">
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="tel" class="form-control" name="phone" id="phone" placeholder="Il Numero Cellulare" data-rule="minlen:10" maxlength="10" data-msg="Please enter at least 10">
              <div class="validate"></div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="mb-3">
            ...
            <div class="sent-message">La tua prenotazione &eacute; stata registrata correttamente,Grazie!</div>
          </div>
          <div class="text-center"><button type="submit">Prenota appuntamento</button></div>
        </form>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container" id="usernotLogged">
        ...
        <form action="#inserire la servelet---" method="post" role="form" class="php-email-form" >
          ...
          <div class="text-center"><a class="btn btn-primary" href="..\\LOGIN\\login.jsp">Accedi</a></div>
        </form>
