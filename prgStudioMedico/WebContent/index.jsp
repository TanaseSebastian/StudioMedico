<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%!
    String autente_loggato=session.getAttribute();
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
     ...
     <%if(autente_loggato.equals("true"))
     {
    	 Utente user=new;
    	 user=session.getAttribute("SESSION_USER");%>
    	  <a href="#"><span class="d-none d-md-inline">Benvenuto <%=user.getNome()%></span></a>
   <%}else{ %>
      <a href="login.jsp"  class="login-btn scrollto"><span class="d-none d-md-inline">Esegui</span> Login</a>
     <%} %>
    </div>
  </header><!-- End Header -->
