...
public class DBManager {
	...
	public boolean verificaCredenziali(String username, String password) throws Exception {
		String q = "SELECT * FROM UTENTI WHERE USERNAME='" + username + "' AND PASSWORD='" + password + "';";
	...
	public void insertRegistration(String cf, String nome, String cognome, String email, String username, String password)
			throws Exception {
		Statement statement = connessione.createStatement();
		String sql = "INSERT INTO UTENTI VALUES ('"+cf+"," + nome + "','" + cognome + "','" + email + "','" + username
				+ "','" + password + "');";
